...
//      console.log(rando);
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: when we declared the rando varibale by (let) it scopped the value in the code block, so If U want to log it u have to do this inside the code block
  console.log(viewed);
